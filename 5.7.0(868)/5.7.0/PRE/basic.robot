...
56620 ZEM 검색어 자동완성
    ...
    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@text="뽀로로 극장판 바닷속 대모험"]
...
56896 지상파 콘텐츠 시놉시스 내 안내문구 수정
    ...
    FOR  ${i}  IN RANGE    0    3   
        Swipe By Percent    50    80    50    30
    END
    ${text}=    Get Text    xpath=//android.widget.TextView
    Should Contain    ${text}    지상파 콘텐츠의 경우 B tv에서만 시청 가능한 회차는 제공되지 않습니다.지상파 월정액에 가입하시면 모든 회차를 모바일에서 시청하실 수 있습니다.※ 일부 콘텐츠는 방송사, 콘텐츠 제공사 또는 저작권자의 요청에 의해 모바일 시청이 제공되지 않을 수 있습니다.
