...
85740 모비소식 웹페이지 이동규격 inlink로 변경 - 퀵 메뉴
    ...
    FOR  ${i}  IN RANGE    0    10    #모비소식 퀵메뉴 노출시점까지 스크롤
        Swipe By Percent    50    70    50    30
        ${pass}    Run Keyword And Return Status    Wait until Element Is Visible    Xpath=//android.widget.FrameLayout[@resource-id="com.skb.smartrc:id/card_view" and @index="3"]
        Exit For Loop If    ${pass}
    END
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.FrameLayout[@resource-id="com.skb.smartrc:id/card_view" and @index="3"]
    Sleep    1
...
85848 전체 콘텐츠 찜 해제 후 버튼 확인
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.TextView[@text="찜 목록"]
    Sleep    1   
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.ImageView[@content-desc="찜 등록"]    #찜 해제
    Sleep    1
...
56896 지상파 콘텐츠 시놉시스 내 안내문구 수정
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skb.smartrc:id/et_search_bar
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Input Text    com.skb.smartrc:id/top_search_bar    마이 데몬
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.TextView[@text = '마이 데몬']
    Sleep    2
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.view.ViewGroup[@content-desc="마이 데몬"]
    Sleep    1
    FOR  ${i}  IN RANGE    0    3   
        Swipe By Percent    50    70    50    30
    END
    Element Text Should Be    com.skb.smartrc:id/tv_message    지상파 콘텐츠의 경우 B tv에서만 시청 가능한 회차는\n제공되지 않습니다. 지상파 월정액에 가입하시면\n모든 회차를 모바일에서 시청하실 수 있습니다.\n\n※ 일부 콘텐츠는 방송사, 콘텐츠 제공사 또는 저작권자의 요청에 의해\n모바일 시청이 제공되지 않을 수 있습니다.
...
57083 댓글/리뷰 작성 기능 제공 - 댓글 작성 정책-1
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skb.smartrc:id/ll_input_comment
    Sleep    1
...
57287 댓글/리뷰 작성 기능 제공 - 댓글 수정/삭제 정책-1
    ...
    Sleep    2
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.view.ViewGroup[2]/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout[2]/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.widget.RelativeLayout/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]/android.view.ViewGroup/android.view.ViewGroup/android.view.View[1]
    Sleep    2
...
57285 댓글/리뷰 작성 기능 제공 - 댓글 수정/삭제 정책-3
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.Button[@text="취소"]
    Sleep    1
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.TextView[@text="삭제하기"]
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.Button[@text="확인"]
    Sleep    1
...
댓글/리뷰 작성 기능 제공 - 신고-2
    ...
    Element Should Be Visible    Xpath=//android.widget.TextView[@text="타인에 대한 비방 및 욕설"]
    Element Should Be Visible    Xpath=//android.widget.TextView[@text="음란성 또는 청소년에게 부적합한 내용"]
    Element Should Be Visible    Xpath=//android.widget.TextView[@text="상업적 광고/부적절한 홍보 게시물"]
    Element Should Be Visible    Xpath=//android.widget.TextView[@text="개인정보 유출/사생활 침해"]
    Element Should Be Visible    Xpath=//android.widget.TextView[@text="도배성 문구"]
    Element Should Be Visible    Xpath=//android.widget.TextView[@text="스포일러"]
    Element Should Be Visible    Xpath=//android.widget.TextView[@text="신고 사유를 선택해 주세요."]
    Element Should Be Visible    Xpath=//android.widget.Button[@text="신고하기"]
