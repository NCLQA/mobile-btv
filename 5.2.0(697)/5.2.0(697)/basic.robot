...
56620 ZEM 검색어 자동완성
    ...
    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@text="뽀로로와 노래해요 NEW2"]
    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@text="뽀로로 시즌1"]
    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@text="뽀로로와 노래해요 NEW1"]
    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@text="뽀로로 동화나라"]
    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@text="뽀로로 뮤직박스 자동차 노래"]
...
56663 Navigation Back_GNB
    ...
    Should Contain    ${String}    Toast
    Sleep    1
    Page Should Contain Element    Xpath=//android.view.ViewGroup[@content-desc="탐색버튼"]
