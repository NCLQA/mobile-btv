...
56727 시놉시스 > 패키지 시놉시스 > 구조
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.ImageView[@content-desc="모아나 1&2 소장 패키지 [HD]"]
...
85741 모비소식 웹페이지 이동규격 inlink로 변경 - 설정
    ...
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Wait until Element Is Visible    com.skb.smartrc:id/title
...
56896 지상파 콘텐츠 시놉시스 내 안내문구 수정
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skb.smartrc:id/et_search_bar
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Input Text    com.skb.smartrc:id/top_search_bar    푹 쉬면 다행이야
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.TextView[@text ="푹 쉬면 다행이야"]
    Sleep    2
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.view.ViewGroup[@content-desc="푹 쉬면 다행이야"]
    Sleep    1
    FOR  ${i}  IN RANGE    0    3   
        Swipe By Percent    50    70    50    30
    END
    Element Should Be Visible    com.skb.smartrc:id/tv_message
    Element Should Be Visible    Xpath=//android.widget.TextView text="지상파 콘텐츠의 경우 B tv에서만 시청 가능한 회차는 제공되지 않습니다.\n지상파 월정액에 가입하시면 모든 회차를 모바일에서 시청하실 수 있습니다.\n※ 일부 콘텐츠는 방송사, 콘텐츠 제공사 또는 저작권자의 요청에 의해 모바일 시청이\n제공되지 않을 수 있습니다."
