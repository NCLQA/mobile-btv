...
56620 ZEM 검색어 자동완성
    ...
    Wait Until Element Is Visible    Xpath=//android.widget.TextView[@text="뽀로로 동화나라 테마별 이어보기"]
...
85728 Free 채널 재생 중 알림 목록 진입 시 동작
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.view.ViewGroup[@content-desc="정주행TV"]
    Sleep    2
...
56896 지상파 콘텐츠 시놉시스 내 안내문구 수정
    #0. 지상파 월정액 미가입 상태 / 검증 콘텐츠 <태어난 김에 세계일주3>
...
57083 댓글/리뷰 작성 기능 제공 - 댓글 작성 정책-1
    ...
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    com.skb.smartrc:id/et_search_bar
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Input Text    com.skb.smartrc:id/top_search_bar    해치지 않아
    Sleep    1
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.widget.TextView[@text = '해치지 않아']
    Sleep    2
    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    Xpath=//android.view.ViewGroup[@content-desc="해치지않아"]
    Sleep    1
